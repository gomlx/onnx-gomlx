...
func convertMultiHeadAttention(_ *Model, _ map[string]*Node, node *protos.NodeProto, inputs []*Node) *Node {
	...
	output, _ := attention.Core(nil, query, key, value, scaleValue, attentionMask, nil, attention.LayoutBHSD, false, false, 0)
...
func convertGroupQueryAttention(_ *Model, convertedOutputs map[string]*Node, node *protos.NodeProto, inputs []*Node) *Node {
	...
	output, _ := attention.Core(nil, query, presentKey, presentValue, scaleValue, mask, nil, attention.LayoutBHSD, false, false, 0)
